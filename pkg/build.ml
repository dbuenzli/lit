...
let () = 
  Pkg.describe "lit" ~builder:`OCamlbuild [
    ...
    Pkg.lib ~cond:tgls ~exts:Exts.module_library "src/lit_gl3"; 
    Pkg.lib ~cond:tgls ~exts:Exts.module_library "src/lit_gl4";
    Pkg.lib ~cond:tgls ~exts:Exts.module_library "src/lit_gles2";
